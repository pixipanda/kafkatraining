 ...
 */
public class AsynchronousOffsetCommit implements  Runnable{

    private final KafkaConsumer<String, String> consumer;
    private final String topic;

    public AsynchronousOffsetCommit(String brokers, String groupId, String topic) {
    ...
    public void run() {
        while (true) {
            ...
            for (ConsumerRecord<String, String> record : records) {
                ...
                // Manually committing offset Asynchronously
                try {
    ...
    public static void main(String[] args) {
        ...
        String topic = args[1];
        AsynchronousOffsetCommit consumer = new AsynchronousOffsetCommit("localhost:9092", groupId, topic);
