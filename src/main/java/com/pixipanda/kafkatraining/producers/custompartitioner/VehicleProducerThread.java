...
public class VehicleProducerThread implements Runnable{
    ...
    public VehicleProducerThread(String brokers, String topic) {
    ...
    private static Properties createProducerConfig(String brokers) {
        ...
        props.put("partitioner.class", "VehiclePartitioner");
        props.put("partitions.0","DELHI");
        props.put("partitions.1","MUMBAI");
        props.put("partitions.2","KOLKATA");
        props.put("partitions.3","CHENNAI");
        return props;
    }
    ...
    public static void main(String[] args) {
        ...
        String topic = args[0];
        VehicleProducerThread producerThread = new VehicleProducerThread("localhost:9092", topic);
